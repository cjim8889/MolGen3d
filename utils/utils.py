...
def create_model(config):
    if config['flow'] == "CoorFlow":
        model = config['model'](hidden_dim=config['hidden_dim'], activation=config['activation'], act_norm=config['act_norm'] ,gnn_size=config['gnn_size'], block_size=config['block_size'])
